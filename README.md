...
Contexte
Ce projet s’inscrit dans le cadre d’un test technique pour un poste de Technicien Supérieur Systèmes et Réseaux (TSSR). L' objectif est de concevoir et configurer une infrastructure réseau simple permettant la communication entre deux réseaux locaux distincts à l’aide d’un routeur.
